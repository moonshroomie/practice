restaurants = ["Raising Canes", "Chick Fil A", "Taco Bell", "McDonald's", "Burger King"]

print("Welcome to your restaurant ranker! Your current ranking is", restaurants, "! You can add and rank a new restaurant!")
